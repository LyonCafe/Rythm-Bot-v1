...
if (!args[0]) {
        ...
        ]);	const msg = await message.channel.send(`<a:load:908666726529531944> Turning on **bassboost**.`);
		...
		const msg = await message.channel.send(`<a:load:908666726529531944> Turning off **bassboost**.`);
