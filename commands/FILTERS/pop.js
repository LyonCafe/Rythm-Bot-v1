...
if (!args[0]) {
	player.setEQ([{
        ...
        const msg = await message.channel.send(`<a:load:908666726529531944> Turning on **pop**.`);
		...
		const msg = await message.channel.send(`<a:load:908666726529531944> Turning off **pop**.`);
			const embed = new MessageEmbed()
