...
[INVITE ME](https://discord.com/oauth2/authorize?client_id=919516113891647519&scope=bot&permissions=32507912)
[SUPPORT SERVER](https://discord.gg/VMK3BydthU)
      `)
...
if (message.author.bot) return;
  ...
  if (command.botPermission) {
    ...
    if (neededPerms.length) return message.channel.send(`<:errorr:917789780580921385> I need ${neededPerms.join(", ")} permission(s) to execute the command!`)
  } 
   if (command.userPermission) {
    ...
    if (neededPerms.length) return message.channel.send(`<:errorr:917789780580921385> You need ${neededPerms.join(", ")} permission(s) to run the command!`)
  }
